...
import { signInWithEmail, signInWithGoogle, isAuthenticated } from "@/services/authService";
    ...
    <div className="flex items-center justify-center min-h-screen bg-background">
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          ...
          >
            <svg className="mr-2 h-4 w-4" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
